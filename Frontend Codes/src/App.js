...
import { checkAuthAsync, selectLoggedInuser, selectLoggedInuserToken } from './features/auth/authSlice';
...
useEffect(()=>{
  ...
  useEffect(()=>{
    ...
    //we can get req.user by token on backend so no need in front end
